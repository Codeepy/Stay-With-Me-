...
package com.codeepy.staywithme.app.bluetooth.v2;
...
public class DeviceScanActivity extends ListActivity {
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            viewHolder.deviceRSSI.setText(Integer.parseInt(device.getRssi())*-1 + " dB");
    ...
    private BluetoothAdapter.LeScanCallback mLeScanCallback =
        ...
        public void onLeScan(final BluetoothDevice device, final int rssi, byte[] scanRecord) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    mLeDeviceListAdapter.addDevice(new BluetoothObject(device.getAddress(), device.getName(), String.valueOf(rssi)));
